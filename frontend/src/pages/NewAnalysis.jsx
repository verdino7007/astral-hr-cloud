...
function NewAnalysis() {
  ...
  return (
    <div className="w-full font-montserrat relative">
      ...
      {/* ── Main Grid ── */}
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-12 xl:gap-16 relative z-10">
        ...
        <motion.div
          ...
          className="xl:col-span-4 h-fit relative"
        >
          {/* Decorative Clay Ring in background */}
          <div className="absolute -top-6 -left-6 w-16 h-16 rounded-full bg-gradient-to-br from-white to-clay-peach border-2 border-white shadow-clay-card z-0 flex items-center justify-center floating-slow">
            <Sparkles className="w-6 h-6 text-clay-orange" />
          </div>

          <div className="card p-8 lg:p-10 relative z-10 slant-left slant-hover">
            {/* Card Header */}
          ...
          <AnimatePresence mode="wait">
            ...
            {!analysisResult && !loading ? (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -10 }}
                className="card p-12 lg:p-16 text-center flex flex-col items-center justify-center min-h-[500px] slant-right slant-hover"
              >
                <div className="w-20 h-20 rounded-[24px] bg-gradient-to-br from-white to-clay-peach flex items-center justify-center mb-8 shadow-clay-card border-2 border-white floating-slow">
              ...
              >
                ...
                <motion.div variants={itemVariants} className="relative z-20 flex flex-col md:flex-row gap-6 items-stretch">
                  ...
                  {/* Name + Tab Switcher - Slanted Right and Underneath */}
                ...
                {/* ── Holistic Synthesis (Dynamic overlapping block) ── */}
                    ...
                    <AnimatePresence mode="wait">
                      ...
                      {activeTab === 'bazi' && (
                        <motion.div key="tab-bazi" initial={{opacity: 0, y: 12}} animate={{opacity:1, y:0}} exit={{opacity:0, y:-12}} className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                          ...
                          {/* Polar Card styling - Polaroid look */}
                      ...
                      {activeTab === 'primbon' && (
                        <motion.div key="tab-primbon" initial={{opacity: 0, y: 12}} animate={{opacity:1, y:0}} exit={{opacity:0, y:-12}} className="flex flex-col items-center py-8 space-y-10 relative">
                          {/* Layered arrangement: weton card slightly overlapping details card */}
                      ...
                      {activeTab === 'falakiyah' && (
                        <motion.div key="tab-falakiyah" initial={{opacity: 0, y: 12}} animate={{opacity:1, y:0}} exit={{opacity:0, y:-12}} className="flex flex-col gap-10 w-full">
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
                            ...
                            {/* Spiritual Patch */}
                            <div className="card p-8 bg-gradient-to-br from-white to-clay-peach/20 border-white flex flex-col justify-between shadow-clay-card slant-right slant-hover relative z-0 md:-ml-4 lg:mt-0">
                              {/* Floating sticker label */}
                              <div className="absolute -top-3.5 left-6 px-3 py-1 bg-gradient-to-r from-clay-orange to-clay-orange-dark text-white text-[9px] font-black rounded-full shadow-clay-btn tracking-widest uppercase">
                                📿 Dhikr
                              </div>
                          ...
                          {/* Planetary Positions (Overlapping Deck structure) */}
